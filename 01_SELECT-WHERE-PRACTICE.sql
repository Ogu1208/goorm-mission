...
select emp_id, emp_name, salary, dept_code, job_code
	from employee
    where salary between 3000000 and 5500000;
...
select emp_id, emp_name, hire_date
	from employee
   -- where LOCATE('김', employee.emp_name);
    where INSTR(employee.emp_name, '김');
...
select emp_id, emp_name, phone
	from employee
    where length(phone) > 10 and phone like '___9%';
...
select emp_name, salary, job_code
	from employee
    where (job_code = 'J2' and salary >= 200)
		or job_code = 'J7';
